...
public class RBGenerator {
	...
	public CSPOM generate() throws FailedGenerationException {
		...
		for (int i = 0; i < activeConstraints.length; i++) {
			...
			buildExplicitConstraint(cspom, involvedVariables, tightnessMode, tightness,
	...
	private CSPOMConstraint buildExplicitConstraint(CSPOM problem, IntVariable[] variables,
